    ...
    <div className="w-full relative">
      <div className="h-5/6 w-full flex justify-center items-center flex-col">
        <div className="relative text-left ">
          <h1 className="hero-title">Connect with Doctors Anytime, Anywhere</h1>
          <h2 className="hero-subtitle">
            Discover why hundreds of professionals trust First MD for their
          ...
          >
            <Link
              to="/SignUp"
              className="btn my-0 font-semibold text-xl border-2 shadow-lg shadow-blue-500"
            >
              {" "}
              Get Started
            </Link>
